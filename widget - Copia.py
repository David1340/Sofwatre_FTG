...
class Widget(QWidget):
                    ...
                    for id_totem, estrutura in totems.items():
                        ...
                        for intervalo in estrutura["intervalos"]:
                            if intervalo["inicio"] is not None and intervalo["fim"] is not None:
                                ...
                                intervalos_processados.append((intervalo["inicio"],diferenca_tempo, intervalo["btn_3"] + intervalo["btn_4"]))
    ...
    def gerar_relatorio(self):
        ...
        if resultados:
            ...
            plt.title("Medidas de Tempo para 8 Corridas", fontsize=18)
            plt.xlabel("Corridas",fontsize=14)
            ...
            for paragraph in doc.paragraphs:
                if palavra_chave in paragraph.text:
                    ...
                    paragraph.add_run().add_picture('grafico_temp.png', width=Inches(5))
